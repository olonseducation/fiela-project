        ...
        return (
          <div className="space-y-4 font-[Nunito] text-amber-950">
            ...
            <ol className="list-decimal pl-5 space-y-3">
              ...
              <li>{showTranslation ? <span dangerouslySetInnerHTML={{__html: "Selesaikan <span class='font-bold'>Kuis Tantangan</span> ekspedisi untuk mendapat skor tertinggi."}} /> : <span dangerouslySetInnerHTML={{__html: "Complete the expedition <span class='font-bold'>Challenge Quiz</span> to collect the highest score."}} />}</li>
