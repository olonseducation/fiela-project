              ...
              {(() => {
                ...
                return (
                  <div className="relative w-full max-w-4xl mt-16 md:mt-12">
                    <Button onClick={() => { soundEffects.buttonNavigation?.(); setSelectedIsland(null); }} className="absolute -top-14 left-0 rounded-xl px-4 py-2 font-[Coiny] leading-one text-base sm:text-lg shadow-lg border-2 z-50 hover:scale-105 transition-transform" style={{ backgroundColor: 'rgba(255, 255, 255, 0.95)', borderColor: 'rgba(74, 144, 164, 0.6)', color: '#2E5266' }}>
                        ...
                        <div className="bg-[#faf6f1] rounded-lg shadow-xl overflow-hidden border border-amber-900/20 relative m-3">
                            ...
                            <div className="p-5 sm:p-6 lg:p-10 relative">
                              ...
                              <div className="flex flex-wrap gap-2 lg:gap-3 mb-6 lg:mb-10">
                                <span className="text-xs sm:text-sm lg:text-base bg-[#0a6f99] text-amber-100 px-2.5 sm:px-3 lg:px-4 py-1.5 lg:py-2 rounded-lg border border-amber-200/90 font-[Coiny] leading-one font-medium flex items-center gap-1 lg:gap-2 text-shadow-md">📜 Story</span>
                                <span className="text-xs sm:text-sm lg:text-base bg-[#0a6f99] text-amber-100 px-2.5 sm:px-3 lg:px-4 py-1.5 lg:py-2 rounded-lg border border-amber-200/90 font-[Coiny] leading-one font-medium flex items-center gap-1 lg:gap-2 text-shadow-md">📖 Vocabulary</span>
                                <span className="text-xs sm:text-sm lg:text-base bg-[#0a6f99] text-amber-100 px-2.5 sm:px-3 lg:px-4 py-1.5 lg:py-2 rounded-lg border border-amber-200/90 font-[Coiny] leading-one font-medium flex items-center gap-1 lg:gap-2 text-shadow-md">🎯 Quest</span>
                              </div>
                              ...
                              <motion.div animate={{ scale: [1, 1.05, 1] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} className="w-full flex justify-center mt-6 lg:mt-8">
                                <Button 
                                  ...
                                  className="w-auto max-w-sm lg:max-w-md mx-auto bg-gradient-to-r from-amber-700 via-amber-800 to-amber-900 hover:from-amber-800 hover:via-amber-900 hover:to-amber-950 text-[#f4ebe0] rounded-xl py-4 md:py-6 px-6 sm:px-8 md:px-16 text-md sm:text-md md:text-lg lg:text-2xl font-[Coiny] leading-one tracking-wide shadow-lg border-2 border-amber-950/30 transition-transform active:scale-95"
                                >
