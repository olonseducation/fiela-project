...
export const units: Unit[] = [
  {
    ...
    story: [
      {
        id: 1,
        text: "The alarm clock rings loudly. Ring! Ring! Ring! Fiela slowly opens her eyes. She stretches her arms and lets out a big yawn. Her room is bright and warm. The sun is shining through the window.",
        translation: "Jam beker berdering nyaring. Kring! Kring! Kring! Fiela perlahan membuka matanya. Dia merentangkan tangannya dan menguap lebar. Kamarnya terang dan hangat. Matahari bersinar masuk dari jendela.",
        dialogue: [
